...
const transferTheme = obj => {
  ...
  /** **************加载 font-face start*************/
  const $style = jquery('<style data-name="theme" type="text/css"></style>')
  ...
  /** **************加载 primary start*************/
  const primaryColor = obj.primary || '#04407c'
  ...
  /** **************加载 success start*************/
  const successColor = obj.success || '#63cb30'
  ...
  /** **************加载 warning start*************/
  const warningColor = obj.warning || '#e6a23c'
  ...
  /** **************加载 danger start*************/
  const dangerColor = obj.danger || '#f33'
